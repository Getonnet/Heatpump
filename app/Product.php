...
class Product extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['product_categories_id', 'product_brands_id', 'name', 'product_types', 'capacity', 'noise_level', 'price', 'photo', 'other_needs', 'deleted_at', 'created_at', 'updated_at'];
